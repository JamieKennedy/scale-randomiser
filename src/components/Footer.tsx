export default function Footer() {
  ...
  return (
    <footer className="mt-20 border-t px-4 pb-10 pt-8 text-muted-foreground">
      <div className="mx-auto flex w-full max-w-5xl flex-col items-center justify-between gap-4 text-center sm:flex-row sm:text-left">
        <p className="m-0 text-sm">
          &copy; {year} Jamie Kennedy. All rights reserved.
        </p>
      </div>
      <div className="mt-4 flex justify-center gap-4">
        <a
          href="https://github.com/JamieKennedy/scale-randomiser"
          target="_blank"
          rel="noreferrer"
